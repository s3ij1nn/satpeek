...
<section class="hero">
    <div class="hero__inner">
        <div>
            ...
            <p class="lede">
                Bots drain other PTC sites. SatPeek locks them out by design — so your clicks are worth more here. Withdraw to FaucetPay from <b style="color: var(--text-primary);"><?php echo e(number_format(config('satpeek.faucetpay.min_withdraw_sat'))); ?> sat</b>. No faucets, no fake balances.
            </p>

            <div class="cta-row">
                <a href="<?php echo e(route('register')); ?>" class="cta cta--primary">
            ...
            <div class="value-strip" aria-label="At a glance">
                <div class="value-strip__cell">
                    <span class="value-strip__num"><?php echo e(number_format(config('satpeek.faucetpay.min_withdraw_sat'))); ?><small>sat</small></span>
                    <span class="value-strip__label">Min payout</span>
                </div>
                <div class="value-strip__cell">
                    <span class="value-strip__num"><?php echo e((int) config('satpeek.referral.commission_pct')); ?><small>%</small></span>
...
<section class="section" id="how">
    ...
    <div class="how">
        ...
        <div class="how__step">
            <h4>Cash out</h4>
            <p>Trigger a withdrawal above <?php echo e(number_format(config('satpeek.faucetpay.min_withdraw_sat'))); ?> sat. FaucetPay processes the payout from queue.</p>
        </div>
    </div>
</section>
...
<section class="section" id="numbers">
    ...
    <div class="numbers">
        <div class="numbers__cell">
            <div class="numbers__num"><?php echo e((int) (config('satpeek.captcha.min_solve_ms') / 1000 * 1000)); ?><small>ms</small></div>
            <div class="numbers__label">min solve · scripts below</div>
        </div>
        <div class="numbers__cell">
            <div class="numbers__num"><?php echo e((int) (config('satpeek.captcha.max_solve_ms') / 1000)); ?><small>s</small></div>
...
<section class="section" id="advertise">
    ...
    <div class="container" style="margin-top: 1.5rem; display: flex; justify-content: space-between; flex-wrap: wrap; gap: 1rem; align-items: baseline;">
        <p style="color: var(--text-tertiary); font-family: var(--font-mono); font-size: var(--text-xs); margin: 0; letter-spacing: 0.04em;">
            Cost = reward × <?php echo e(100 + (int) config('satpeek.ads.commission_pct')); ?>% (incl. <?php echo e((int) config('satpeek.ads.commission_pct')); ?>% platform fee) · every campaign is reviewed before going live · bid <?php echo e((int) config('satpeek.ads.reward_min_sat')); ?>–<?php echo e((int) config('satpeek.ads.reward_max_sat')); ?> sat / view · <?php echo e(number_format((int) config('satpeek.ads.views_min'))); ?>+ views
        </p>
        <a href="<?php echo e(auth()->check() ? route('advertise.create') : route('register')); ?>" class="cta cta--ghost" style="font-size: var(--text-sm);">
            <?php echo e(auth()->check() ? 'Launch a campaign' : 'Create a free account'); ?> <span class="cta__arrow">→</span>
        </a>
    </div>
</section>
