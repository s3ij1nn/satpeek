...
<section class="sl">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($links->isEmpty()): ?>
        <div class="empty">
    ...
    <?php else: ?>
        <div class="row-list">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <?php
                    $left = max(0, (int) $l->daily_limit_per_user - (int) ($usedToday[$l->id] ?? 0));
                    $exhausted = $left <= 0;
                ?>
                <article class="row <?php echo e($exhausted ? 'exhausted' : ''); ?>" data-link-id="<?php echo e($l->id); ?>" data-target="<?php echo e($l->target_url); ?>" data-hold="<?php echo e($l->hold_seconds); ?>" data-reward="<?php echo e($l->reward_sat); ?>">
                    <div>
                        <h3 class="row__title"><?php echo e($l->title); ?></h3>
                        <div class="row__meta"><?php echo e($l->source); ?> · <?php echo e($l->hold_seconds); ?>s hold · <?php echo e($left); ?>/<?php echo e($l->daily_limit_per_user); ?> left today</div>
                    </div>
                    <div class="row__reward"><?php echo e(number_format($l->reward_sat)); ?><small>sat</small></div>
                    <div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.trajectory-captcha','data' => ['name' => 'sl']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['name' => 'sl']); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /var/www/resources/views/shortlinks/index.blade.php ENDPATH**/ ?>