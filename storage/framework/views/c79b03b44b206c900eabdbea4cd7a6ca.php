    ...
    <div class="site-header__inner">
        ...
        <nav class="nav" aria-label="Main">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(auth()->guard()->check()): ?>
                ...
                <a href="<?php echo e(route('ptc.index')); ?>">PTC</a>
                <a href="<?php echo e(route('shortlinks.index')); ?>">Shortlinks</a>
                <a href="<?php echo e(route('advertise.index')); ?>">Advertise</a>
                <a href="<?php echo e(route('withdraw.index')); ?>">Withdraw</a>
                <a href="<?php echo e(route('referral.index')); ?>">Referral</a>
                <span class="balance"><?php echo e(number_format(auth()->user()->balance_sat)); ?> sat</span>
                <form method="POST" action="<?php echo e(route('logout')); ?>" style="display:inline;"><?php echo csrf_field(); ?><button class="btn-ghost">Logout</button></form>
            <?php else: ?>
                <a href="<?php echo e(route('home')); ?>#how">How it works</a>
                <a href="<?php echo e(route('home')); ?>#advertise">Advertise</a>
                <a href="<?php echo e(route('home')); ?>#defense">Defense</a>
                <a href="<?php echo e(route('login')); ?>">Login</a>
                <a href="<?php echo e(route('register')); ?>" class="nav__cta">Sign up <span aria-hidden="true">→</span></a>
    ...
    <div class="site-footer__inner">
        ...
        <div class="site-footer__col">
            ...
            <ul>
                ...
                <li>Min withdrawal: <?php echo e(number_format(config('satpeek.faucetpay.min_withdraw_sat'))); ?> sat</li>
            </ul>
        </div>
        <div class="site-footer__legal">© <?php echo e(date('Y')); ?> SatPeek</div>
    </div>
</footer>
